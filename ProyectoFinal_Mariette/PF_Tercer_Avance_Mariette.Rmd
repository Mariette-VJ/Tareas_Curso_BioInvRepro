...
### Sexta etapa: predicción de OTUs
...
### Última etapa: obtener sólo las abundancias relativas de Archeas en una tabla comparativa entre los tres metagenomas

  $ for file in PAzules*.txt; do grep 'Archaea' $file > $file.Archaea; done
  
  $ utils/merge_metaphlan_tables.py predict_otus/*.Archaea > output/merged_Archaea_abundance_table.txt